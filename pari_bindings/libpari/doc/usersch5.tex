...
$$\min\big(\max(\kbd{maxprime}, 65557), 436273289\big).$$
...
\fun{ulong}{maxprimelim}{void} the argument used for the last \kbd{initprimes}
call. This belongs to $[65537, 436273289]$ and the largest prime
...
\kbd{diffptr}. Never change \kbd{diffptr} directly, call this function
